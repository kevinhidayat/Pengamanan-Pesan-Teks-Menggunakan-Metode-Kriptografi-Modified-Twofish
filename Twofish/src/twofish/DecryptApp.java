 ...
 * @author dell
 */
public class DecryptApp extends javax.swing.JFrame {
...
//    private String encryptionKey192bit = "D1079B789F666649B6BD7D1629F1F77E7AFF7A70CA2FF28A";
    ...
    private void initComponents() {
        ...
        Decrypt_Files = new javax.swing.JButton();
        ...
        Decrypt_Files.setText("Decrypt File");
        Decrypt_Files.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Decrypt_FilesActionPerformed(evt);
            }
        });
        ...
        Decrypt_Button.setBackground(new java.awt.Color(255, 0, 0));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(Decrypt_Files, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(Decrypt_Files, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void Decrypt_FilesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Decrypt_FilesActionPerformed
        try {
            String cek = Key.getText();
            String kunci = aewordchange.getMd5(cek);
            if(!"".equals(cek)){
                String simpankata = Cyphertext.getText();
                encryptionkey = kunci;
                double startTime = System.nanoTime();
                byte[] fileCiphertext = Twofish.twofishECBDecryptNoPadding(temporaryword, encryptionkey);
                double endTime = System.nanoTime(); 
                Time.setText((endTime - startTime)/1000000 + " Ms");
                Notification.setText("SUCCESS DECRYPTION");
                Notification.setForeground(Color.green);
                ciphertemp = fileCiphertext;
                Plainttext.setText(new String(ciphertemp));
            }else{
                JOptionPane.showMessageDialog(this, "Input the key");
            }
        } catch (Exception ex) {
            Notification.setText("FAILED DECRYPTION");
            Notification.setForeground(Color.red);
        }
    }//GEN-LAST:event_Decrypt_FilesActionPerformed
    ...
    private void Save_FilesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Save_FilesActionPerformed
        try {
            ...
            String ambilnama = Cyphertext.getText();
    ...
    private void Get_FilesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Get_FilesActionPerformed
        try {
            ...
            if(pilih == chooser.APPROVE_OPTION){
                ...
                temporaryword = readfiles;
                String changefiles = new String(readfiles);
                Cyphertext.setText(changefiles);
    ...
    private void Save_Files2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Save_Files2ActionPerformed
        try{
            if(!"".equals(Plainttext.getText())){
                String namafiles = JOptionPane.showInputDialog("Type file encryption name");
                byte[] simpanfiles = ciphertemp;
                File encryptedFile = new File("examples/" + namafiles + ".txt");
                Files.write(encryptedFile.toPath(), simpanfiles);
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DecryptApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JButton Decrypt_Files;
