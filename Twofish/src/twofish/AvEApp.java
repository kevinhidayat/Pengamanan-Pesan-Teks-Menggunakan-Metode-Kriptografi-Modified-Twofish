...
import static twofish.aewordchange.EncryptionLooping;

/**
 *
 * @author dell
 */
public class AvEApp extends javax.swing.JFrame {
...
//    private String encryptionKey192bit = "D1079B789F666649B6BD7D1629F1F77E7AFF7A70CA2FF28A";
    ...
    private void initComponents() {
        ...
        AvalancheEffect_Name = new javax.swing.JLabel();
        ...
        Encrypt_Button.setBackground(new java.awt.Color(51, 255, 255));
        ...
        AvalancheEffect_Button.setBackground(new java.awt.Color(255, 0, 0));
        ...
        Cyphertext.setFont(new java.awt.Font("Monospaced", 0, 16)); // NOI18N
        Cyphertext.setLineWrap(true);
        Cyphertext.setRows(5);
        Cyphertext.setToolTipText("");
        jScrollPane4.setViewportView(Cyphertext);

        AvalancheEffect_Name.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        AvalancheEffect_Name.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        AvalancheEffect_Name.setText("AVALANCHE EFFECT");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(AvalancheEffect_Name, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(Get_Files, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 99, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(Encrypt_Button, javax.swing.GroupLayout.PREFERRED_SIZE, 311, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(Decrypt_Button, javax.swing.GroupLayout.PREFERRED_SIZE, 318, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(AvalancheEffect_Button, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(Notification, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jScrollPane3, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(AvalancheEffect_Name, javax.swing.GroupLayout.PREFERRED_SIZE, 52, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void Encrypt_FilesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Encrypt_FilesActionPerformed
        try {
            ...
            String kunci = aewordchange.getMd5(cek);
            if(!"".equals(cek)){
                String simpankata = Plainttext.getText();
                byte[] perubahansimpankata = simpankata.getBytes();
                encryptionkey = kunci;
                double startTime = System.nanoTime();
                String kumpulan = EncryptionLooping(Plainttext.getText(), encryptionkey);
                double endTime = System.nanoTime(); 
                Time.setText((endTime - startTime)/1000000 + " Ms");
                Notification.setText("SUCCESS SAVING FILE ENCRYPTION");
                Notification.setForeground(Color.green);
                ciphertemp = kumpulan;
                Cyphertext.setText(kumpulan);
            ...
            Notification.setText("FAILED SAVING FILE ENCRYPTION");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AvEApp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JLabel AvalancheEffect_Name;
